    ...
    <footer className="flexy justify-between! max-sm:flex-col max-sm:gap-4 bg-[var(--bg-projects)] py-8 px-15 max-sm:px-5">
      ...
      >
        <div className="flexy gap-4 max-[400px]:flex-col max-sm:order-1">
          ...
          <p className="font-medium max-sm:text-sm max-[400px]:text-center">
            &copy; {t("2025 Abderrahmane Lartab. All rights reserved")}
          </p>
        </div>
      </FadeContent>
      <div className="flexy gap-4">
        <FadeContent
          ...
          initialOpacity={0}
        >
          <a href="https://linkedin.com/in/alartab" target="_blank">
            <svg
              viewBox="0 0 20 20"
              version="1.1"
        ...
        <FadeContent
          ...
          initialOpacity={0}
        >
          <a href="https://github.com/Abderrahmane-lrt" target="_blank">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              className="size-6.5"
        ...
        <FadeContent
          ...
          initialOpacity={0}
        >
          <a href="https://www.instagram.com/abderrahmane_lartab" target="_blank">
