...
export const Projects = () => {
  ...
  const projects = [

    {
      ...
      image: "/photos/projects/pipeline/pipeline.png",
      page: <Pipeline />,
    },
    {
      name: "Tech-News",
      description: t("technews_description"),
      date: "02/2025 - 03/2025",
      image: "/photos/projects/technews/technews.png",
      page: <TechNews />,
    },
    {
      name: "Park-Smart",
      description: t("parksmart_description"),
