    ...
    <div className='relative min-h-screen flex items-center justify-center bg-[var(--bg-primary)] font-["CabinetGrotesk"]'>
      <div className="w-full max-w-4xl px-4 sm:px-6 md:px-12 ">
        <div className="flex justify-center">
          <img
            src="/photos/projects/pipeline/pipeline_laptop.png"
            alt="Pipeline Project"
            className="w-full max-w-3xl h-auto p-4 rounded-lg shadow-[var(--custom-shadow)]"
          />
        </div>
        <div className="flex justify-center mt-6">
          <a
            href="https://sales-force-maroc-crm.vercel.app/"
            target="_blank"
